...
<title>관리자페이지_게시판관리(연-결 성혼 스토리)admin_MngBoard_WeddingStoryRead2</title>
				...
				<table class="table table-bordered table-hover">
					<thead>
						<tr>
							...
							<th class="text-left" id="subject">조금 더 이해하면, 이렇게 사랑을 꽃 피울 수 있어요.</th>
							<th class="date">2019-10-17</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<br /><br />
							<img src="${pageContext.request.contextPath}/assets/img/성혼스토리9-1.png"><br /><br />
								...
								<img src="${pageContext.request.contextPath}/assets/img/성혼스토리9-2.jfif"><br /><br /><br /><br />
								</div>								
