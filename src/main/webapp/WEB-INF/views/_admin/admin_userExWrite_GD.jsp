...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/assets/css/GD/Admin/userexwrite.css">
...
<body>
	...
	<div class="container">
		...
		<div class="col-md-10 middle_box">
			...
			<button onclick="location='admin_QnA_GD.jsp'" class="btn ">연-결 Q &amp; A</button>
			<button onclick="location='admin_userEx_GD.jsp'" class="btn  btn-info">연-결 만남 후기</button>
		</div>
		...
		<div class="col-md-10 text_box">
			...
			<div class="pull-right">
				...
				<button class="btn btn-default" onclick="location=''">취소</button>
			</div>
