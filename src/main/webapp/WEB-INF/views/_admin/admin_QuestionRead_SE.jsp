		...
		<div class="col-md-10 text_box">
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th class="text-center" id="textarea">문의 드립니다.</th>
							<th class="text-center" id="title">작성자</th>
							<th class="text-center" id="userid">최유한</th>
							<th class="text-center" id="title">문의일</th>
							<th class="text-center" id="date">19.10.01</th>
			...
			<div class="pull-right">
				<button class="btn btn-default"
					onclick="location.href = '${pageContext.request.contextPath}/_admin/admin_QuestionAnswer1_SE.do'">답변쓰기</button>
				<button class="btn btn-default"
