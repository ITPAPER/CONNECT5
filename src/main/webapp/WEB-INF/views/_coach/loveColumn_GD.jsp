...
<div class="table-responsive">
			<table width="850" align="center" class="bottom">
				<tr>
					<td id="first"><div class="table">
							<a href="${pageContext.request.contextPath}/_coach/readTip_GD.do"> <img src="${pageContext.request.contextPath}/assets/img/col_thumb_1.PNG" width="250"
								height="150"></a></td>
					<td width="500" height="200"><a href="readColumn_GD.jsp"><h4>조금만 달리하면 상대가 보이는 만남의 법칙</h4></a>
				...
				<tr>
					<td><div class="table">
							<a href="#"> <img src="${pageContext.request.contextPath}/assets/img/col_thumb_2.PNG" width="250"
								height="150"></a></td>
					<td width="500" height="200"><a href="#"><h4>결혼은 미친 짓 일까?</h4></a>
				...
				<tr>
					<td><div class="table">
							<a href="#"> <img src="${pageContext.request.contextPath}/assets/img/col_thumb_3.PNG" width="250"
								height="150"></a></td>
					<td width="500" height="200"><a href="#"><h4>내 짝을 찾는 간단한 방법</h4></a>
				...
				<tr>
					<td><div class="table">
					<a href="#"> <img src="${pageContext.request.contextPath}/assets/img/col_thumb_4.PNG" width="250"
								height="150"></a></td>
					<td width="500" height="200"><a href="#"><h4>나에게도 사랑이 올까요?</h4></a>
