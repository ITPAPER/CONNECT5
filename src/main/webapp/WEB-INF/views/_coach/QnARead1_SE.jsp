...
<body>
	...
	<div class="col-md-10 content">
				...
				<tbody>
					...
					<tr>
						...
						<th colspan="2" align="center"><a
							href="${pageContext.request.contextPath}/QnA/QnARead2_SE.do">헤어진 지 1년, 도저히 못 잊겠는데?</a></th>
					</tr>
				</tbody>
			</table>
		</div>
		...
		<button class="btn btn-default pull-right"
			onclick="location.href = '${pageContext.request.contextPath}/QnA/QnA_SE.do'">목록</button>
