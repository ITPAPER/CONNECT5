...
<body>
	<div class="col-md-12 footer">
		<ul>
			<li><a href="../_info/IntroWebsite_YB.jsp">회사소개</a>
				<div class="vi"></div></li>
			<li><a href="../_service/MembershipRegisGuide_YB.jsp">가입안내</a>
				<div class="vi"></div></li>
			<li><a href="../_service/ServiceProcedures_YB.jsp">서비스이용절차</a>
				<div class="vi"></div></li>
			<li><a href="../_info/map_GD.jsp">오시는길</a>
				<div class="vi"></div></li>
			<li><a href="../_info/partner_HG.jsp">연-결 제휴 파트너</a>
				<div class="vi"></div></li>
	...
	<div class="col-md-12 footer_information">
		<div class="col-md-offset-2 footer_information_image">
			<img src="../img/footerMain.PNG" width="150" height="150">
		</div>
