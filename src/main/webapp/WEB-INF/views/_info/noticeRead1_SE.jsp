		...
		<div class="table-responsive">
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
						<th id="num">제목</th>
						<th>'창립 10주년 기념' 적극적인 서비스로 높은 성혼율 달성</th>
						<th id="date">2019.10.22</th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						<th>이전글</th>
						<th colspan="2" align="center"><a href="${pageContext.request.contextPath}/_info/noticeRead2_SE.do">신원인증 강화와 적극적인 서비스 제공으로 고객만족 실현</a></th>
					</tr>
				</tbody>
			</table>
		</div>
