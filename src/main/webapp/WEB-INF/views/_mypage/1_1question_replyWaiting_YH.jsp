...
<script>
	function add() {
		...
		location.href = "${pageContext.request.contextPath}/_mypage/1_1questionWrite_YH.do";
	}
</script>
	...
	<div class="col-md-10 content">
		...
		<div class="pull-right">
			...
			<button class="btn btn-default"
				onclick="location.href='${pageContext.request.contextPath}/_mypage/1_1question_replyWait_YH.do'">확인</button>
		</div>
	</div>
