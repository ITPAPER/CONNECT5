...
<script>
	...
	function cancel() {
		...
		location.href = "${pageContext.request.contextPath}/_mypage/withdrawal1_HG.do";
	}
</script>
...
<jsp:include page="../assets/inc/top.jsp" />
				...
				<table class="table table-bordered table-hover">
					<thead class="thead1">
						<tr>
							...
							<th class="text-center" id="name1">남희권</th>
							<th class="text-center" id="num">아이디</th>
							<th class="text-center"><input type="text"
								placeholder="아이디입력란" id="textarea2" /></th>
							<th class="text-center" id="num">비밀번호</th>
							<th class="text-center"><input type="text"
								placeholder="비밀번호입력란" id="textarea1" /></th>
						</tr>
						<tr>
					...
					<tr>
					<th class="text-center" colspan="6"><input class="text4" type="radio" name="ex" checked />이용이 불편하고 장애가 많음&nbsp;&nbsp;&nbsp;&nbsp;
						<input class="text4" type="radio" name="ex" checked />사용빈도가 낮아서&nbsp;&nbsp;&nbsp;&nbsp;
						<input class="text4" type="radio" name="ex" checked />서비스 불만&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="ex" />기타</th>
					</tr>
	...
	<div class="b1">
			<button class="btn btn-default" onclick="cancel()"style="height: 30px; width: 80px;">취소</button>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
			<button class="btn btn-default" onclick="yes()"style="height: 30px; width: 80px;">탈퇴하기</button>
		</div>
			</div>
		</div>
